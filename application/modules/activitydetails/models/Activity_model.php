...
class Activity_model extends CI_Model {
	...
	var $column_order = array(null, 'a.location', 'a.region', 'a.snu', 'a.starts', 'a.ends', 'a.region_id','a.snu_id','a.notes');
	var $column_search = array('a.location', 'a.region', 'a.snu', 'a.starts', 'a.ends', 'a.region_id','a.snu_id','a.notes');
	...
	private function getQuery() {
		...
		$this->db->select(array('a.activity_id', 'a.location', 'a.region', 'a.snu', 'a.starts', 'a.ends','a.region_id','a.snu_id', 'a.notes'));
