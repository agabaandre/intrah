...
class Admin extends MX_Controller {
	...
	public function regions_list() {
		...
		$data = array(
			'title' => 'Regions',
			'regions' => $this->admin_model->get_regions_list($page, $config["per_page"], $key),
	...
	public function districts_list() {
		...
		$data = array(
			'title' => 'Districts',
			'districts' => $this->admin_model->get_districts_list($page, $config["per_page"], $key),
			'links' => $this->pagination->create_links(),
			'username' => $this->username,
			//'switches'=>$this->switches()
		);
	...
	public function snus_list() {
		...
		$data = array(
			'title' => 'SNUs',
			'snus' => $this->admin_model->get_snus_list($page, $config["per_page"], $key),
			'links' => $this->pagination->create_links(),
			'username' => $this->username,
			//'switches'=>$this->switches()
		);
	...
	public function public_holidays() {
		...
		$data = array(
			...
			'public_holidays' => $this->admin_model->get_public_holidays_list($page, $config["per_page"], $key),
			'links' => $this->pagination->create_links(),
			'username' => $this->username,
			//'switches'=>$this->switches()
		);
	...
	public function activities_scheduled_report() {
		...
		$data = array(
			...
			'activities' => $this->admin_model->list_activities_scheduled($month, $year),
			'username' => $this->username,
		);
