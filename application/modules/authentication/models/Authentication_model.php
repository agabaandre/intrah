...
class Authentication_model extends CI_Model {
	...
	function validate_login($postData) {
		...
		$this->db->select('user.name as names,user.username,user.password,user.status,user.email,user.user_id,user.role,user.auth_id, user.changed as password_state');
