                ...
                <div class="sidebar-wrapper">
                    <ul class="nav">
                        ...
                        <?php if ($user_position) { ?>
                            ...
                            <li class="<?php if ($ccontroller == "website" || $ccontroller == "page" || $ccontroller == "menu" || $ccontroller == "section") { echo "active"; } ?> nav_parent">
                                <a> <i class="material-icons">format_align_center</i> <p><?php echo $this->lang->line('dash_menu_website'); ?> <i class="right material-icons ">add_circle</i>	</p></a>
...
<!--                <div class="demoNotification">
                    <h1 class="text-red text-center">This is a demo version, few things are restricted for safety for both of us.</h1>
                </div>-->
